...
HELPER="$HELPER_DIR/node_net_loss_helper.sh"

# == Environment Variables ==================================================================================
# Parameter names must match net-payload-env.loss.configmap.yaml:
...
#   LOG_DIR
BLADE_NAME="chaosblade-singlenode-net-loss-payload-node4"
TARGET_NODE="node4"

# loss params
PERCENT="10"          # [0,100] int
INTERFACE="ens33"     # node interface, e.g. eth0/ens33
...
DESTINATION_IP="-"
EXCLUDE_IP="-"
EXCLUDE_PORT="22,9090,8080,9100"
